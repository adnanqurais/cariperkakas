	...
	var ElevateZoom = {
			init: function( options, elem ) {
				...
				$('#'+self.options.gallery + ' a').click( function(e) {
					...
					self.swaptheimage($(this).data("image"), self.zoomImagePre).fadeIn(200);
					return false;
				});
...
//					calculate new width ratio
	...
	$.fn.elevateZoom.options = {
      ...
      zoomEnabled: true, //false disables zoomwindow from showing
			...
			cursor:"zoom", // user should set to what they want the cursor as, if they have set a click function
			responsive:true,
			onComplete: $.noop,
      onDestroy: function() {},
