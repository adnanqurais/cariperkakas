        ...
        <section class="content">
          <div class="row">
            <div class="col-xs-12">
                ...
                @endif
              <div class="box">
                <form class="discount-form form-horizontal" action="{{ url('admin/discount/add') }}" method="post">
                    ...
                    <div class="col-md-6">
                      <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input id="discountName" class="form-control" placeholder="Name" name="discountName">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input id="discountValue" type="number" class="form-control" placeholder="Value" name="discountValue" min="0">
                            </div>
                        </div>
                        <div class="form-group">
